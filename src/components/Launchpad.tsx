  ...
  return (
    ...
    >
      <div className="size-full absolute bg-gray-900/20 backdrop-blur-2xl">
        <div
          className="mx-auto flex h-7 w-64 mt-5 bg-gray-200/10 border border-gray-200/30 rounded-md"
        ...
        <div
          className="max-w-[1100px] mx-auto mt-8 w-full px-4 sm:px-10 grid grid-flow-row grid-cols-4 sm:grid-cols-7"
        >
          {search().map((app) => (
